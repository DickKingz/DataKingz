...
interface DroneAugmentsPageProps {
  onBack: () => void;
}

const DroneAugmentsPage: React.FC<DroneAugmentsPageProps> = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      <div className="px-8 py-8">
        <button onClick={onBack} className="mb-6 flex items-center gap-3 text-gray-400 hover:text-white">
          <ArrowLeft className="w-5 h-5" /> Back to Set 1
        </button>
        <h1 className="text-5xl font-black mb-8 text-white">DRONE AUGMENTS</h1>
        {/* Filter Bar */}
